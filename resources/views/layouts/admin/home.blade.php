...
<head>
  ...
  <style>
    .back-arrow{color:white;transition:all .36s ease-in}.back-arrow:hover{color:#a9a9a9}body{display:flex;min-height:100vh;flex-direction:column}main{flex:1 0 auto}.jqstooltip{width:50px;height:35px}
  </style>
...
<main>
  ...
  <section class="bar-top">
    ...
    <span class="user-info">
        ...
        <b>Olá, {{ $fName }}</b>
      <a href="{{ route('logout') }}" class="logout-user" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
