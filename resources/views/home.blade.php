        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div class="last-news">
                    <div class="box">
                        <div class="row">
                            <div class="title"><i class="ion-ios-analytics" style="font-size: 25px"></i> Sites
                            </div>
                        </div>
                        <main>
                            <ul>
                                <li class="title">Site 1 criação • dentro de 4 semanas</li>
                                <li>Site 2 / 10 meses</li>
            ...
            <div class="container">
                ...
                <div class="panel panel-twuiseo">
                    ...
                    <div class="panel-body">
                        <p>Olá, para criar um novo projeto por favor, preencha abaixo os dados sobre o seu novo
                            projeto.</p>
                    ...
                    <div class="panel-footer">
                        <button type="submit" value="Enviar para orçamento" class="btn btn-tw-reply"><i
                                    class="fa fa-check"></i> Enviar para o orçamento
                        </button>
                    </div>
                    </form>
        ...
        <div class="row navigation">
            ...
            <div class="tabs">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active"><a href="#sites" role="tab" data-toggle="tab"><i
                                    class="ion-ios-home-outline"></i>
                            <b>Sites</b></a></li>
                    <li><a href="#project" role="tab" data-toggle="tab"><i class="fa fa-stack-exchange"></i>
                            <b>Projetos</b></a>
                    </li>
                    <li><a href="#support" role="tab" data-toggle="tab"><i class="fa fa-flag"></i> <b>Suporte</b></a>
                    </li>
                    <li><a href="#configuration" role="tab" data-toggle="tab"><i class="fa fa-cogs"></i> <b>Configurações</b></a>
                    </li>
                    <li><a href="#vendas" role="tab" data-toggle="tab"><i class="fa fa-usd"></i> <b>Suas Vendas</b></a>
                    </li>
                </ul>
                <!-- TAB CONTENT -->
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="panel panel-twuiseo">
                                    ...
                                    <div class="panel-body">
                                        <img src="../resources/images/others/site.png"
                                             class="img-responsive site-illustration"
                                ...
                                @foreach($nP as $projeto)
                                    <tr>
                                        ...
                                        @else
                                            ...
                                            <td>
                                                @if($projeto->finish != null)
                                                    @php
                                                        $update = new Date($projeto->finish);
                    ...
                    <div class="tab-pane fade" id="support">
                        <div class="row support-message">
                                        ...
                                        @foreach($c as $msg)
                                            ...
                                            >
                                                <td class="icon-support">
                                                    <img src="{{ asset('resources/images/others/support-icon.svg') }}"
                                                         alt="">
                                                </td>
                            ...
                            @else
                                <h4 align="center" style="margin-bottom: 0;margin-top: 15px"><i
                                            class="ion-ios-close-circle"></i> Nenhuma mensagem aqui</h4>
                            @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"><i class="fa fa-bullhorn" aria-hidden="true"></i>
                                                Novo Chamado</h4>
                                        </div>
